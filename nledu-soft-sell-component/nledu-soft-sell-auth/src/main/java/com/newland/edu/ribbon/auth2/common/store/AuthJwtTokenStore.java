...
import com.newland.edu.ribbon.auth2.common.converter.CustomUserAuthenticationConverter;
 ...
 * @date 2020/6/27
 */
@ConditionalOnProperty(prefix = "xmg.oauth2.token.store", name = "type", havingValue = "authJwt")
