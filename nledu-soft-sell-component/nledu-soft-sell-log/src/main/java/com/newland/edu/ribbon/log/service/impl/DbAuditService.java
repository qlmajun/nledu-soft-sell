...
/**
 * @author majun
 * @description 审计日志接口实现-数据库
 * @date 2020/8/31
 */
@ConditionalOnProperty(name = "xmg.audit-log.log-type", havingValue = "db")
@ConditionalOnClass(JdbcTemplate.class)
public class DbAuditService implements IAuditService {
    ...
    public DbAuditService(@Autowired(required = false) LogDbProperties logDbProperties, DataSource dataSource) {
