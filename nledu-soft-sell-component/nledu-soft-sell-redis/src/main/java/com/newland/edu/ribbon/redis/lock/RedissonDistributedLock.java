package com.newland.edu.ribbon.redis.lock;

import com.warrior.central.common.constant.CommonConstant;
import com.warrior.central.common.exception.LockException;
...
@ConditionalOnProperty(prefix = "xmg.lock", name = "lockerType", havingValue = "REDIS", matchIfMissing = true)
